 ...
 * @generated
 */
public class PagediagramInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new PagediagramNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				WebChunkTypeEditPart.MODEL_ID));
		PagediagramDiagramEditorUtil.runWizard(getShell(), wizard,
