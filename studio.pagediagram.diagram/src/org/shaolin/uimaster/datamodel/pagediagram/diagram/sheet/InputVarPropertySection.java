 ...
 * @generated
 */
public class InputVarPropertySection extends AbstractModelerPropertySection implements
		IPropertySourceProvider {

	private InputVarPropertyUI ui = null;
	
	public void createControls(final Composite parent,
	            TabbedPropertySheetPage aTabbedPropertySheetPage) {
	        super.createControls(parent, aTabbedPropertySheetPage);
	        
	        ui = new InputVarPropertyUI(parent, SWT.NONE);
	}
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		if (ui != null) {
			if (this.getEObject() instanceof WebChunkType) {
				ui.init(this.getEObject(), ((WebChunkType)this.getEObject()).getGlobalVariable());
			} else if (this.getEObject() instanceof StartNodeType) {
				ui.init(this.getEObject(), ((StartNodeType)this.getEObject()).getVariables());
			} else if (this.getEObject() instanceof LogicNodeType) {
				ui.init(this.getEObject(), ((LogicNodeType)this.getEObject()).getVariables());
			} else if (this.getEObject() instanceof PageNodeType) {
				ui.init(this.getEObject(), ((PageNodeType)this.getEObject()).getVariables());
			} 
		}
