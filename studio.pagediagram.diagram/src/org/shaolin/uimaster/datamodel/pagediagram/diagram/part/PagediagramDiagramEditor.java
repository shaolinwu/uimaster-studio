 ...
 * @generated
 */
public class PagediagramDiagramEditor  extends org.eclipse.gmf.runtime.diagram.ui.resources.editor.parts.DiagramDocumentEditor implements org.eclipse.ui.ide.IGotoMarker {

		/**
 * @generated
 */
public static final String ID = "org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramDiagramEditorID";  //$NON-NLS-1$
	
	/**
 * @generated
 */
public static final String CONTEXT_ID = "org.shaolin.uimaster.datamodel.pagediagram.diagram.ui.diagramContext";  //$NON-NLS-1$
	
		/**
 * @generated
 */
public PagediagramDiagramEditor() {
	super(true);
}
...
protected org.eclipse.gef.palette.PaletteRoot createPaletteRoot(org.eclipse.gef.palette.PaletteRoot existingPaletteRoot) {
	...
	new org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramPaletteFactory().fillPalette(root);
	return root;
}
...
protected org.eclipse.gmf.runtime.diagram.core.preferences.PreferencesHint getPreferencesHint() {
	return org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT;
}
...
public String getContributorId() {
	return org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramDiagramEditorPlugin.ID;
}
...
protected org.eclipse.gmf.runtime.diagram.ui.resources.editor.document.IDocumentProvider getDocumentProvider(org.eclipse.ui.IEditorInput input) {
	if (input instanceof org.eclipse.ui.IFileEditorInput || input instanceof org.eclipse.emf.common.ui.URIEditorInput) {
		return org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramDiagramEditorPlugin.getInstance().getDocumentProvider();
	}
...
protected void setDocumentProvider(org.eclipse.ui.IEditorInput input) {
	if (input instanceof org.eclipse.ui.IFileEditorInput || input instanceof org.eclipse.emf.common.ui.URIEditorInput) {
		setDocumentProvider(org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramDiagramEditorPlugin.getInstance().getDocumentProvider());
	} else {
...
protected void performSaveAs(org.eclipse.core.runtime.IProgressMonitor progressMonitor) {
	...
	if (provider.isDeleted(input) && original != null) {
		String message = org.eclipse.osgi.util.NLS.bind(org.shaolin.uimaster.datamodel.pagediagram.diagram.part.Messages.PagediagramDiagramEditor_SavingDeletedFile, original.getName());
	...
	for (int i = 0; i < editorRefs.length; i++) {
		if (matchingStrategy.matches(editorRefs[i], newInput)) {
			org.eclipse.jface.dialogs.MessageDialog.openWarning(shell, org.shaolin.uimaster.datamodel.pagediagram.diagram.part.Messages.PagediagramDiagramEditor_SaveAsErrorTitle, org.shaolin.uimaster.datamodel.pagediagram.diagram.part.Messages.PagediagramDiagramEditor_SaveAsErrorMessage);
			return;
		}
	}
	...
	try {
		...
		if (status == null || status.getSeverity() != org.eclipse.core.runtime.IStatus.CANCEL) {
			org.eclipse.jface.dialogs.ErrorDialog.openError(shell, org.shaolin.uimaster.datamodel.pagediagram.diagram.part.Messages.PagediagramDiagramEditor_SaveErrorTitle, org.shaolin.uimaster.datamodel.pagediagram.diagram.part.Messages.PagediagramDiagramEditor_SaveErrorMessage, x.getStatus());
		}
	} finally {
 ...
 */
	protected void configureGraphicalViewer() {
		...
		org.shaolin.uimaster.datamodel.pagediagram.diagram.part.DiagramEditorContextMenuProvider provider =
				new org.shaolin.uimaster.datamodel.pagediagram.diagram.part.DiagramEditorContextMenuProvider(this, getDiagramGraphicalViewer());
