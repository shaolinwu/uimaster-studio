 ...
 * @generated
 */
public class ScriptOperationPropertySection extends AbstractModelerPropertySection implements
		IPropertySourceProvider {

	private ScriptOperationUI ui = null;
	
	public void createControls(final Composite parent,
	            TabbedPropertySheetPage aTabbedPropertySheetPage) {
	        super.createControls(parent, aTabbedPropertySheetPage);
	        
	        ui = new ScriptOperationUI(parent, SWT.NONE);
	}
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		if (ui != null) {
			WebNodeType node = (WebNodeType)this.getEObject();
			ui.init(node);
		}
