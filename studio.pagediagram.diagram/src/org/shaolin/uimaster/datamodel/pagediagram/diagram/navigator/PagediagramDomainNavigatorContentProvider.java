 ...
 * @generated
 */
public class PagediagramDomainNavigatorContentProvider implements org.eclipse.ui.navigator.ICommonContentProvider {
 ...
 * @generated
 */
public PagediagramDomainNavigatorContentProvider() {
	myAdapterFctoryContentProvier = new org.eclipse.emf.edit.ui.provider.AdapterFactoryContentProvider(org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory());
...
org.eclipse.emf.ecore.resource.Resource resource = myEditingDomain.getResourceSet().getResource(fileURI, true);
	...
	if (parentElement instanceof org.shaolin.uimaster.datamodel.pagediagram.diagram.navigator.PagediagramDomainNavigatorItem) {
		return wrapEObjects(myAdapterFctoryContentProvier.getChildren(((org.shaolin.uimaster.datamodel.pagediagram.diagram.navigator.PagediagramDomainNavigatorItem) parentElement).getEObject()), parentElement);
	}
	return EMPTY_ARRAY;
}
...
public Object[] wrapEObjects(Object[] objects, Object parentElement) {
	...
	for (int i = 0; i < objects.length; i++) {
		if (objects[i] instanceof org.eclipse.emf.ecore.EObject) {
			result.add(new org.shaolin.uimaster.datamodel.pagediagram.diagram.navigator.PagediagramDomainNavigatorItem((org.eclipse.emf.ecore.EObject) objects[i], parentElement, myAdapterFctoryContentProvier));
		}
	}
