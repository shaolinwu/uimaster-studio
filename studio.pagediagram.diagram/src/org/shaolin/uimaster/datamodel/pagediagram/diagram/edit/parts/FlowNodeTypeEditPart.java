...
import org.shaolin.uimaster.datamodel.pagediagram.diagram.edit.policies.FlowNodeTypeItemSemanticEditPolicy;

/**
 * @generated
 */
public class FlowNodeTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	protected FlowNodeTypeFigure primaryShape;

	/**
	 * @generated
	 */
	public FlowNodeTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FlowNodeTypeItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new FlowNodeTypeFigure(getFlowNode());
	}

	/**
	 * @generated
	 */
	public FlowNodeTypeFigure getPrimaryShape() {
		return (FlowNodeTypeFigure) primaryShape;
	}

	public FlowNodeType getFlowNode() {
		FlowNodeType impl = null;
		Shape model = ((Shape) getModel());
		impl = (FlowNodeType)model.getElement();
		return impl;
	}
	 ...
	 * @generated
	 */
	public class FlowNodeTypeFigure extends RoundedRectangle {
		...
		private final FlowNodeType model;
		
		/**
		 * @generated
		 */
		public FlowNodeTypeFigure(FlowNodeType model) {
			this.model = model;
		...
		private void createContents() {
			...
			Label inputInfo = new Label("Mapping Variables: ");
		...
		public void refreshBody() {
			if (model.getDestChunkName() != null) {
				String info = model.getDestChunkName().getEntityName() + "-->" + model.getDestNode();
				nameLabel.setText("To Flow: " + info);
			} else {
				nameLabel.setText("To Flow: ? ");
			}
			
			fieldPanel.removeAll();
			
			EList<NameExpressionType> params = model.getDataMappingToNode();
			for (NameExpressionType p: params) {
				String info = p.getName() +" : "+ p.getExpression().getExpressionString();
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureFlowNodeTypeNameFigure() {
			return nameLabel;
		}
