 ...
 * @generated
 */
public class PagediagramDiagramEditorUtil {
 ...
 */
	public static boolean openDiagram(org.eclipse.emf.ecore.resource.Resource diagram) throws org.eclipse.ui.PartInitException {
		...
		if (workspaceResource instanceof org.eclipse.core.resources.IFile) {
			...
			return null != page.openEditor(new org.eclipse.ui.part.FileEditorInput((org.eclipse.core.resources.IFile) workspaceResource), org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramDiagramEditor.ID);
		}
		return false;
	}
 ...
 */
	public static void setCharset(org.eclipse.core.resources.IFile file) {
		...
		try {
			...
			org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramDiagramEditorPlugin.getInstance().logError("Unable to set charset for file " + file.getFullPath(), e);  //$NON-NLS-1$
		}
	}	
 ...
 */
	...
	public static void runWizard(org.eclipse.swt.widgets.Shell shell, org.eclipse.jface.wizard.Wizard wizard, String settingsKey) {
		org.eclipse.jface.dialogs.IDialogSettings pluginDialogSettings = org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramDiagramEditorPlugin.getInstance().getDialogSettings();
 ...
 */
	public static org.eclipse.emf.ecore.resource.Resource createDiagram(org.eclipse.emf.common.util.URI diagramURI, org.eclipse.emf.common.util.URI modelURI, org.eclipse.core.runtime.IProgressMonitor progressMonitor) {
		...
		progressMonitor.beginTask(org.shaolin.uimaster.datamodel.pagediagram.diagram.part.Messages.PagediagramDiagramEditorUtil_CreateDiagramProgressTask, 3);
		...
		org.eclipse.gmf.runtime.emf.commands.core.command.AbstractTransactionalCommand command = new org.eclipse.gmf.runtime.emf.commands.core.command.AbstractTransactionalCommand(editingDomain, org.shaolin.uimaster.datamodel.pagediagram.diagram.part.Messages.PagediagramDiagramEditorUtil_CreateDiagramCommandLabel, java.util.Collections.EMPTY_LIST) {
			protected org.eclipse.gmf.runtime.common.core.command.CommandResult doExecuteWithResult(org.eclipse.core.runtime.IProgressMonitor monitor, org.eclipse.core.runtime.IAdaptable info) throws org.eclipse.core.commands.ExecutionException {
				org.shaolin.uimaster.datamodel.pagediagram.WebChunkType model = createInitialModel();
				...
				try {
					modelResource.save(org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramDiagramEditorUtil.getSaveOptions());
					...
					org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramDiagramEditorPlugin.getInstance().logError("Unable to store model and diagram resources", e);  //$NON-NLS-1$
				}
		...
		try {
			...
			org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramDiagramEditorPlugin.getInstance().logError("Unable to create model and diagram", e);  //$NON-NLS-1$
		}
 ...
 * @generated
 */
	private static org.shaolin.uimaster.datamodel.pagediagram.WebChunkType createInitialModel() {
		return org.shaolin.uimaster.datamodel.pagediagram.PageDiagramFactory.eINSTANCE.createWebChunkType();
	}
 ...
 * @generated
 */
	private static void attachModelToResource(org.shaolin.uimaster.datamodel.pagediagram.WebChunkType model, org.eclipse.emf.ecore.resource.Resource resource) {
 ...
 * @generated
 */
	private static org.shaolin.uimaster.datamodel.pagediagram.DocumentRoot createDocumentRoot(org.shaolin.uimaster.datamodel.pagediagram.WebChunkType model) {
		
			org.shaolin.uimaster.datamodel.pagediagram.DocumentRoot docRoot = org.shaolin.uimaster.datamodel.pagediagram.PageDiagramFactory.eINSTANCE.createDocumentRoot();
