 ...
 * @generated
 */
public class PagediagramNavigatorActionProvider  extends org.eclipse.ui.navigator.CommonActionProvider {
...
public OpenDiagramAction(org.eclipse.ui.navigator.ICommonViewerWorkbenchSite viewerSite) {
	super(org.shaolin.uimaster.datamodel.pagediagram.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
...
public final void selectionChanged(org.eclipse.jface.viewers.IStructuredSelection selection) {
	...
	if (selection.size() == 1) {
		...
		if (selectedElement instanceof org.shaolin.uimaster.datamodel.pagediagram.diagram.navigator.PagediagramNavigatorItem) {
			selectedElement = ((org.shaolin.uimaster.datamodel.pagediagram.diagram.navigator.PagediagramNavigatorItem) selectedElement).getView();
		...
		if (selectedElement instanceof org.eclipse.gmf.runtime.notation.Diagram) {
			...
			if (org.shaolin.uimaster.datamodel.pagediagram.diagram.edit.parts.WebChunkTypeEditPart.MODEL_ID.equals(org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramVisualIDRegistry.getModelID(diagram))) {
				myDiagram = diagram;
			}
		}
	}
...
public void run() {
	...
	org.eclipse.ui.IWorkbenchPage page = myViewerSite.getPage();
 	try {
		page.openEditor(editorInput, org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramDiagramEditor.ID);
	} catch (org.eclipse.ui.PartInitException e) {
		org.shaolin.uimaster.datamodel.pagediagram.diagram.part.PagediagramDiagramEditorPlugin.getInstance().logError("Exception while openning diagram", e);  //$NON-NLS-1$
	}
}
