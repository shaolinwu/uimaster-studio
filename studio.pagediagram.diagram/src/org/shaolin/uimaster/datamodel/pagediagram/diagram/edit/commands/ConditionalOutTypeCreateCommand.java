 ...
 * @generated
 */
public class ConditionalOutTypeCreateCommand extends
	 ...
	 * @generated
	 */
	public ConditionalOutTypeCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return PagediagramBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateConditionalOutType_4001(getContainer(), getSource(),
						getTarget());
	}
	...
	protected org.eclipse.gmf.runtime.common.core.command.CommandResult doExecuteWithResult(
		...
		ConditionalOutType newElement = PageDiagramFactory.eINSTANCE
				.createConditionalOutType();
		getContainer().getOut().add(newElement);
		newElement.setName(getSource().getName() + "-linksTo-"
				+ getTarget().getName());
	 ...
	 * @generated
	 */
	protected void doConfigure(ConditionalOutType newElement,
			org.eclipse.core.runtime.IProgressMonitor monitor,
			org.eclipse.core.runtime.IAdaptable info)
			throws org.eclipse.core.commands.ExecutionException {
		org.eclipse.gmf.runtime.emf.type.core.IElementType elementType = ((CreateElementRequest) getRequest())
				.getElementType();
	 ...
	 * @generated
	 */
	private static WebNodeType deduceContainer(
			org.eclipse.emf.ecore.EObject source,
			org.eclipse.emf.ecore.EObject target) {
		// Find container element for the new link.
		// Climb up by containment hierarchy starting from the source
		// and return the first element that is instance of the container class.
		for (org.eclipse.emf.ecore.EObject element = source; element != null; element = element
				.eContainer()) {
