...
public class InputVarPropertyUI extends Composite {
	...
	public void init(EObject container, EList<ParamType> parameters) {
		this.container = container;
		this.parameters = parameters;
		
//		parameters.get(0).getName();
//		parameters.get(0).getCategory();
//		parameters.get(0).getType();
//		parameters.get(0).getDefault();
//		parameters.get(0).getScope();
//		parameters.get(0).getNotes();
