...
/**
 * This is the item provider adapter for a {@link org.shaolin.uimaster.datamodel.rdbdiagram.ViewType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewType_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewType_op_feature", "_UI_ViewType_type"),
				 RDBDiagramPackage.Literals.VIEW_TYPE__OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RDBDiagramPackage.Literals.VIEW_TYPE__BASE_TABLE);
			childrenFeatures.add(RDBDiagramPackage.Literals.VIEW_TYPE__EXT_TABLE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RDBDiagramPackage.Literals.VIEW_TYPE__BASE_TABLE,
				 CommonFactory.eINSTANCE.createTargetEntityType()));

		newChildDescriptors.add
			(createChildParameter
				(RDBDiagramPackage.Literals.VIEW_TYPE__EXT_TABLE,
				 CommonFactory.eINSTANCE.createTargetEntityType()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == RDBDiagramPackage.Literals.VIEW_TYPE__BASE_TABLE ||
			childFeature == RDBDiagramPackage.Literals.VIEW_TYPE__EXT_TABLE;
