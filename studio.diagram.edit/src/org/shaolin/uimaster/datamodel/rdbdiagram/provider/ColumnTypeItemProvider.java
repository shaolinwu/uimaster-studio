...
/**
 * This is the item provider adapter for a {@link org.shaolin.uimaster.datamodel.rdbdiagram.ColumnType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ColumnType_comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ColumnType_comment_feature", "_UI_ColumnType_type"),
				 RDBDiagramPackage.Literals.COLUMN_TYPE__COMMENT,
				 true,
				 false,
				 false,
	...
	protected void addDefaultPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ColumnType_default_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ColumnType_default_feature", "_UI_ColumnType_type"),
				 RDBDiagramPackage.Literals.COLUMN_TYPE__DEFAULT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIsNullPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ColumnType_isNull_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ColumnType_isNull_feature", "_UI_ColumnType_type"),
				 RDBDiagramPackage.Literals.COLUMN_TYPE__IS_NULL,
				 true,
				 false,
				 false,
	...
	protected void addLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ColumnType_length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ColumnType_length_feature", "_UI_ColumnType_type"),
				 RDBDiagramPackage.Literals.COLUMN_TYPE__LENGTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RDBDiagramPackage.Literals.COLUMN_TYPE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPrecisionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ColumnType_precision_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ColumnType_precision_feature", "_UI_ColumnType_type"),
				 RDBDiagramPackage.Literals.COLUMN_TYPE__PRECISION,
				 true,
				 false,
				 false,
	...
	protected void addRedundantPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ColumnType_redundant_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ColumnType_redundant_feature", "_UI_ColumnType_type"),
				 RDBDiagramPackage.Literals.COLUMN_TYPE__REDUNDANT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RDBDiagramPackage.Literals.COLUMN_TYPE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
