...
public class BENameTypeDirectEditPolicy extends DirectEditPolicy {
	...
	protected void showCurrentEditValue(DirectEditRequest request) {
		...
		BENodeTypeEditPart editPart = (BENodeTypeEditPart)this.getHost();
