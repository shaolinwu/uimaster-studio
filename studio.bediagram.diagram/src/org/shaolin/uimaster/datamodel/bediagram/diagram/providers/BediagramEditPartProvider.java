...
import org.shaolin.uimaster.datamodel.bediagram.diagram.edit.parts.BediagramEditPartFactory;
import org.shaolin.uimaster.datamodel.bediagram.diagram.part.BediagramVisualIDRegistry;

/**
 * @generated
 */
public class BediagramEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public BediagramEditPartProvider() {
		setFactory(new BediagramEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!BEDiagramTypeEditPart.MODEL_ID
					.equals(BediagramVisualIDRegistry.getModelID(view))) {
				return false;
			}
