 ...
 * @generated
 */
public class BediagramInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new BediagramNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				BEDiagramTypeEditPart.MODEL_ID));
		BediagramDiagramEditorUtil.runWizard(getShell(), wizard,
