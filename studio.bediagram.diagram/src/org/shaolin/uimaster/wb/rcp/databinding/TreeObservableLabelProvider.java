 ...
 *******************************************************************************/
package org.shaolin.uimaster.wb.rcp.databinding;
...
import org.shaolin.uimaster.datamodel.bediagram.impl.MemberTypeImpl;
...
public class TreeObservableLabelProvider extends LabelProvider {
	...
	public String getText(Object element) {
		if (element instanceof MemberTypeImpl) {
			return ((MemberTypeImpl)element).getName() + " : " + 
					BETypeConvertor.TYPE_CLASSES.get(((MemberTypeImpl)element).getType().getClass());
		} else if (element instanceof ColumnType) {
			return ((ColumnType)element).getName() + " : " + 
					((ColumnType)element).getType().toString();
		} else {
