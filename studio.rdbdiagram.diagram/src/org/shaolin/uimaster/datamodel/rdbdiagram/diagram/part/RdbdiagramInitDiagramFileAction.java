 ...
 * @generated
 */
public class RdbdiagramInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new RdbdiagramNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				RDBDiagramTypeEditPart.MODEL_ID));
		RdbdiagramDiagramEditorUtil.runWizard(getShell(), wizard,
