 ...
 * @generated
 */
public class RdbdiagramViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return RDBDiagramTypeEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& RdbdiagramVisualIDRegistry
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = RdbdiagramVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = RdbdiagramVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!RdbdiagramElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != RdbdiagramVisualIDRegistry
				...
				if (!RDBDiagramTypeEditPart.MODEL_ID
						.equals(RdbdiagramVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return TableTypeEditPart.VISUAL_ID == visualID
				|| ViewTypeEditPart.VISUAL_ID == visualID
				|| TableMemberTypeEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = RdbdiagramVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != RdbdiagramVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(RDBDiagramTypeEditPart.MODEL_ID);
		diagram.setElement(getSemanticElement(semanticAdapter));
		diagram.setMeasurementUnit(MeasurementUnit.PIXEL_LITERAL);
		
		RDBDiagramType model = (RDBDiagramType)diagram.getElement();
		for (TableType table : model.getTable()) {
			createTableType_2001(table, diagram, ViewUtil.APPEND,
					true, preferencesHint);
		}
		for (ViewType view : model.getView()) {
			createViewType_2002(view, diagram, ViewUtil.APPEND,
					true, preferencesHint);
		}
		for (JoinTableType join : model.getJoinTable()) {
			createJoinTableType_4003(join, diagram, ViewUtil.APPEND,
					true, preferencesHint);
		}
		return diagram;
	}
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = RdbdiagramVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case TableTypeEditPart.VISUAL_ID:
			return createTableType_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case ViewTypeEditPart.VISUAL_ID:
			return createViewType_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case TableMemberTypeEditPart.VISUAL_ID:
			return createTableColumnType_4002(domainElement, containerView,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (RdbdiagramVisualIDRegistry.getVisualID(elementTypeHint)) {
		case JoinTableTypeEditPart.VISUAL_ID:
			return createJoinTableType_4003(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case InheritTypeEditPart.VISUAL_ID:
			return createInheritType_4004(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createTableType_2001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RdbdiagramVisualIDRegistry
				.getType(TableTypeEditPart.VISUAL_ID));
		...
		TableType table = (TableType) domainElement;
		if (table.getMapping() == null) {
			table.setMapping(RDBDiagramFactory.eINSTANCE.createClassMappingType());
		}
		InheritAssociationType inheritAssociate = table.getInheritAsscociation();
		if (inheritAssociate != null) {
			createInheritType_4004(inheritAssociate, containerView, 
					index, persisted, preferencesHint);
		}
		
		Node columnsNode = createCompartment(node, 
				RdbdiagramVisualIDRegistry.getType(TableMemberContainerEditPart.VISUAL_ID), 
				true, false, false, false);
		
		if (table.getColumn().size() == 0) {
			ColumnType newElement = RDBDiagramFactory.eINSTANCE
					.createColumnType();
			newElement.setName("COLUMN0");
			newElement.setType(TypeType.VARCHAR);
			table.getColumn().add(newElement);

			createTableColumnType_4002(newElement, columnsNode, 
						persisted, preferencesHint);
		} else {
			EList<ColumnType> columns = table.getColumn();
			for (ColumnType col : columns) {
				createTableColumnType_4002(col, columnsNode,
						persisted, preferencesHint);
			}
		}
	...
	public Node createTableColumnType_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		//DecorationNode doesn't support Connection.
		//DecorationNode node = NotationFactory.eINSTANCE.createDecorationNode();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RdbdiagramVisualIDRegistry
				.getType(TableMemberTypeEditPart.VISUAL_ID));
	...
	public Node createTableColumnType_4002(EObject domainElement,
			...
			PreferencesHint preferencesHint) {
		return createTableColumnType_4002(domainElement, 
	 ...
	 * @generated
	 */
	public Node createViewType_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RdbdiagramVisualIDRegistry
				.getType(ViewTypeEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences
	 ...
	 * @generated
	 */
	public Edge createJoinTableType_4003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		edge.setType(RdbdiagramVisualIDRegistry
				.getType(JoinTableTypeEditPart.VISUAL_ID));
	...
	public Edge createInheritType_4004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(RdbdiagramVisualIDRegistry
				.getType(InheritTypeEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	...
	private void stampShortcut(View containerView, Node target) {
		if (!RDBDiagramTypeEditPart.MODEL_ID.equals(RdbdiagramVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", RDBDiagramTypeEditPart.MODEL_ID); //$NON-NLS-1$
