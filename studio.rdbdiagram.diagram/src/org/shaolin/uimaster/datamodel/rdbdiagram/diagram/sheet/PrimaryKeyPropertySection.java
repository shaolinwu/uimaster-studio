 ...
 * @generated
 */
public class PrimaryKeyPropertySection extends AbstractModelerPropertySection implements
		IPropertySourceProvider {

	private PrimaryKeyPropertyUI ui = null;
	
	public void createControls(final Composite parent,
	            TabbedPropertySheetPage aTabbedPropertySheetPage) {
        super.createControls(parent, aTabbedPropertySheetPage);
        
        ui = new PrimaryKeyPropertyUI(parent, SWT.NONE);
	}
	...
	protected Object transformSelection(Object selected) {
		...
		if (selected instanceof TableTypeEditPart) {
			Object model = ((TableTypeEditPart) selected).getModel();
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		if (ui != null) {
			ui.init((TableType)this.getEObject());
		}
