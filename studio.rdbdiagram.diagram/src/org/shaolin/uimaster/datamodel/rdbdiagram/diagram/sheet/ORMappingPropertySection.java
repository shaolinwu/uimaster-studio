 ...
 * @generated
 */
public class ORMappingPropertySection extends AbstractModelerPropertySection implements
		IPropertySourceProvider {

	private ORMappingPropertyUI ui = null;
	
	public void createControls(final Composite parent,
	            TabbedPropertySheetPage aTabbedPropertySheetPage) {
	        super.createControls(parent, aTabbedPropertySheetPage);
	        
	        ui = new ORMappingPropertyUI(parent, SWT.NONE);
	}
