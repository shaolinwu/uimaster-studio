...
import org.shaolin.uimaster.datamodel.rdbdiagram.diagram.edit.commands.InheritTypeCreateCommand;
import org.shaolin.uimaster.datamodel.rdbdiagram.diagram.edit.commands.InheritTypeReorientCommand;
import org.shaolin.uimaster.datamodel.rdbdiagram.diagram.edit.commands.JoinTableTypeCreateCommand;
import org.shaolin.uimaster.datamodel.rdbdiagram.diagram.edit.commands.JoinTableTypeReorientCommand;
 ...
 * @generated
 */
public class RdbdiagramBaseItemSemanticEditPolicy extends
	 ...
	 * @generated
	 */
	protected RdbdiagramBaseItemSemanticEditPolicy(
		...
		if (request instanceof org.eclipse.gef.requests.ReconnectRequest) {
			...
			if (view instanceof org.eclipse.gmf.runtime.notation.View) {
				Integer id = new Integer(
						org.shaolin.uimaster.datamodel.rdbdiagram.diagram.part.RdbdiagramVisualIDRegistry
	...
	protected int getVisualID(
			org.eclipse.gmf.runtime.emf.type.core.requests.IEditCommandRequest request) {
	 ...
	 * @generated
	 */
	protected org.eclipse.gef.commands.Command getSemanticCommand(
			org.eclipse.gmf.runtime.emf.type.core.requests.IEditCommandRequest request) {
	 ...
	 * @generated
	 */
	protected org.eclipse.gef.commands.Command addDeleteViewCommand(
			org.eclipse.gef.commands.Command mainCommand,
			org.eclipse.gmf.runtime.emf.type.core.requests.DestroyRequest completedRequest) {
		org.eclipse.gef.commands.Command deleteViewCommand = getGEFWrapper(new org.eclipse.gmf.runtime.diagram.core.commands.DeleteCommand(
				getEditingDomain(),
				(org.eclipse.gmf.runtime.notation.View) getHost().getModel()));
	 ...
	 * @generated
	 */
	private org.eclipse.gef.commands.Command getEditHelperCommand(
			org.eclipse.gmf.runtime.emf.type.core.requests.IEditCommandRequest request,
			org.eclipse.gef.commands.Command editPolicyCommand) {
		if (editPolicyCommand != null) {
			org.eclipse.gmf.runtime.common.core.command.ICommand command = editPolicyCommand instanceof org.eclipse.gmf.runtime.diagram.ui.commands.ICommandProxy ? ((org.eclipse.gmf.runtime.diagram.ui.commands.ICommandProxy) editPolicyCommand)
					.getICommand()
					: new org.eclipse.gmf.runtime.diagram.ui.commands.CommandProxy(
							editPolicyCommand);
	...
	private org.eclipse.gmf.runtime.emf.type.core.IElementType getContextElementType(
			org.eclipse.gmf.runtime.emf.type.core.requests.IEditCommandRequest request) {
		org.eclipse.gmf.runtime.emf.type.core.IElementType requestContextElementType = org.shaolin.uimaster.datamodel.rdbdiagram.diagram.providers.RdbdiagramElementTypes
	 ...
	 * @generated
	 */
	protected org.eclipse.gef.commands.Command getSemanticCommandSwitch(
	 ...
	 * @generated
	 */
	protected org.eclipse.gef.commands.Command getConfigureCommand(
			org.eclipse.gmf.runtime.emf.type.core.requests.ConfigureRequest req) {
		return null;
	}
	...
	private Command getStartCreateRelationshipCommand(
		...
		if (RdbdiagramElementTypes.TableType_JoinTable_4003 == req.getElementType()
				&& req.getSource() instanceof ColumnType) {
			return getGEFWrapper(new JoinTableTypeCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (RdbdiagramElementTypes.TableType_Inherit_4004 == req.getElementType()
				&& req.getSource() instanceof TableType) {
			return getGEFWrapper(new InheritTypeCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		return null;
	}
	 ...
	 * @generated
	 */
	protected org.eclipse.gef.commands.Command getSetCommand(
			org.eclipse.gmf.runtime.emf.type.core.requests.SetRequest req) {
		return null;
	}
	 ...
	 * @generated
	 */
	protected org.eclipse.gef.commands.Command getEditContextCommand(
			org.eclipse.gmf.runtime.emf.type.core.requests.GetEditContextRequest req) {
		return null;
	}
	 ...
	 * @generated
	 */
	protected org.eclipse.gef.commands.Command getDestroyElementCommand(
		...
		if (view.getElement() instanceof TableType) {
			for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
				Edge incomingLink = (Edge) it.next();
				if (RdbdiagramVisualIDRegistry.getVisualID(incomingLink) 
			...
			for (View memeber: list) {
				for (Iterator it = memeber.getTargetEdges().iterator(); it.hasNext();) {
					Edge incomingLink = (Edge) it.next();
					if (RdbdiagramVisualIDRegistry.getVisualID(incomingLink) 
				...
				for (Iterator it = memeber.getSourceEdges().iterator(); it.hasNext();) {
					Edge incomingLink = (Edge) it.next();
					if (RdbdiagramVisualIDRegistry.getVisualID(incomingLink) 
							== JoinTableTypeEditPart.VISUAL_ID) {
						DestroyElementRequest r = new DestroyElementRequest(
	 ...
	 * @generated
	 */
	protected org.eclipse.gef.commands.Command getDestroyReferenceCommand(
	 ...
	 * @generated
	 */
	protected org.eclipse.gef.commands.Command getDuplicateCommand(
			org.eclipse.gmf.runtime.emf.type.core.requests.DuplicateElementsRequest req) {
		return null;
	}
	 ...
	 * @generated
	 */
	protected org.eclipse.gef.commands.Command getMoveCommand(
			org.eclipse.gmf.runtime.emf.type.core.requests.MoveRequest req) {
		return null;
	}
	...
	protected org.eclipse.gef.commands.Command getReorientRelationshipCommand(
		...
		case JoinTableTypeEditPart.VISUAL_ID:
			return getGEFWrapper(new JoinTableTypeReorientCommand(req));
		case InheritTypeEditPart.VISUAL_ID:
			return getGEFWrapper(new InheritTypeReorientCommand(req));
		}
	 ...
	 * @generated
	 */
	protected final org.eclipse.gef.commands.Command getGEFWrapper(
	...
	protected void addDestroyShortcutsCommand(
		...
		for (java.util.Iterator it = view.getDiagram().getChildren().iterator(); it
				.hasNext();) {
			org.eclipse.gmf.runtime.notation.View nextView = (org.eclipse.gmf.runtime.notation.View) it
					.next();
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = org.shaolin.uimaster.datamodel.rdbdiagram.diagram.part.RdbdiagramDiagramEditorPlugin
				.getInstance().getLinkConstraints();
		if (cached == null) {
			org.shaolin.uimaster.datamodel.rdbdiagram.diagram.part.RdbdiagramDiagramEditorPlugin
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public boolean canCreateAssociationType_4003(RDBDiagramType container,
				ColumnType source, ColumnType target) {
			return canExistAssociationType_4003(container, null, source, target);
		}

		/**
		 * @generated
		 */
		public boolean canExistAssociationType_4003(RDBDiagramType container,
				JoinTableType linkInstance, ColumnType source, ColumnType target) {
			return true;
		}
	}
