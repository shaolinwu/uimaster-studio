...
import org.shaolin.uimaster.datamodel.page.UIImageType;

/**
 * This is the item provider adapter for a {@link org.shaolin.uimaster.datamodel.page.UIImageType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UIImageTypeItemProvider
	 ...
	 * @generated
	 */
	public UIImageTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PagePackage.Literals.UI_IMAGE_TYPE__SRC);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UIImageType"));
	}
	...
	public String getText(Object object) {
		String label = ((UIImageType)object).getUIStyle();
		return label == null || label.length() == 0 ?
			getString("_UI_UIImageType_type") :
			getString("_UI_UIImageType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UIImageType.class)) {
			case PagePackage.UI_IMAGE_TYPE__SRC:
	...
	public void collectNewPropertyDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PagePackage.Literals.UI_IMAGE_TYPE__SRC,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == PagePackage.Literals.UI_IMAGE_TYPE__SRC;
