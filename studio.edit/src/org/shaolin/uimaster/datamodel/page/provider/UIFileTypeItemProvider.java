...
import org.shaolin.uimaster.datamodel.page.UIFileType;

/**
 * This is the item provider adapter for a {@link org.shaolin.uimaster.datamodel.page.UIFileType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UIFileTypeItemProvider
	 ...
	 * @generated
	 */
	public UIFileTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UIFileType"));
	}
	...
	public String getText(Object object) {
		String label = ((UIFileType)object).getUIStyle();
		return label == null || label.length() == 0 ?
			getString("_UI_UIFileType_type") :
			getString("_UI_UIFileType_type") + " " + label;
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == PagePackage.Literals.UI_FILE_TYPE__TEXT;
