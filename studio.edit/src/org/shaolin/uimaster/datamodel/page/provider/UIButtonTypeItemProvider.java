...
/**
 * This is the item provider adapter for a {@link org.shaolin.uimaster.datamodel.page.UIButtonType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UIButtonTypeItemProvider
	 ...
	 * @generated
	 */
	public UIButtonTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UIButtonType"));
	}
	...
	public String getText(Object object) {
		String label = ((UIButtonType)object).getUIStyle();
		return label == null || label.length() == 0 ?
			getString("_UI_UIButtonType_type") :
			getString("_UI_UIButtonType_type") + " " + label;
	}
