...
import org.shaolin.uimaster.datamodel.page.UIChoiceType;

/**
 * This is the item provider adapter for a {@link org.shaolin.uimaster.datamodel.page.UIChoiceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UIChoiceTypeItemProvider
	 ...
	 * @generated
	 */
	public UIChoiceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PagePackage.Literals.UI_CHOICE_TYPE__OPTION_VALUE);
		}
	...
	public String getText(Object object) {
		String label = ((UIChoiceType)object).getUIStyle();
		return label == null || label.length() == 0 ?
			getString("_UI_UIChoiceType_type") :
			getString("_UI_UIChoiceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UIChoiceType.class)) {
			case PagePackage.UI_CHOICE_TYPE__OPTION_VALUE:
	...
	public void collectNewPropertyDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PagePackage.Literals.UI_CHOICE_TYPE__OPTION_VALUE,
	...
	public void collectNewActionDescriptors(Collection<Object> newChildDescriptors, Object object) {
		super.collectNewActionDescriptors(newChildDescriptors, object);
		
		newChildDescriptors.add
		(createChildParameter
			(PagePackage.Literals.UI_COMPONENT_TYPE__EVENT_LISTENER,
			 PageFactory.eINSTANCE.createItemChangeListenerType()));
	}
