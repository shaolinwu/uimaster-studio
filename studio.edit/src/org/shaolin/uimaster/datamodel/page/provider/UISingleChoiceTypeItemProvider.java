...
import org.shaolin.uimaster.datamodel.page.UISingleChoiceType;

/**
 * This is the item provider adapter for a {@link org.shaolin.uimaster.datamodel.page.UISingleChoiceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UISingleChoiceTypeItemProvider
	 ...
	 * @generated
	 */
	public UISingleChoiceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PagePackage.Literals.UI_SINGLE_CHOICE_TYPE__SELECTED_VALUE_CONSTRAINT);
			childrenFeatures.add(PagePackage.Literals.UI_SINGLE_CHOICE_TYPE__SELECTED_VALUE_CONSTRAINT_TEXT);
		}
	...
	public String getText(Object object) {
		String label = ((UISingleChoiceType)object).getUIStyle();
		return label == null || label.length() == 0 ?
			getString("_UI_UISingleChoiceType_type") :
			getString("_UI_UISingleChoiceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UISingleChoiceType.class)) {
			case PagePackage.UI_SINGLE_CHOICE_TYPE__SELECTED_VALUE_CONSTRAINT:
			case PagePackage.UI_SINGLE_CHOICE_TYPE__SELECTED_VALUE_CONSTRAINT_TEXT:
	...
	public void collectNewPropertyDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PagePackage.Literals.UI_SINGLE_CHOICE_TYPE__SELECTED_VALUE_CONSTRAINT,
				 PageFactory.eINSTANCE.createValidatorPropertyType()));
		
		newChildDescriptors.add
		(createChildParameter
				(PagePackage.Literals.UI_SINGLE_CHOICE_TYPE__SELECTED_VALUE_CONSTRAINT_TEXT,
