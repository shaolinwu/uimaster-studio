...
import org.shaolin.uimaster.datamodel.page.UIFrameType;

/**
 * This is the item provider adapter for a {@link org.shaolin.uimaster.datamodel.page.UIFrameType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UIFrameTypeItemProvider
	 ...
	 * @generated
	 */
	public UIFrameTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UIFrameType"));
	}
	...
	public String getText(Object object) {
		String label = ((UIFrameType)object).getUIStyle();
		return label == null || label.length() == 0 ?
			getString("_UI_UIFrameType_type") :
			getString("_UI_UIFrameType_type") + " " + label;
	}
