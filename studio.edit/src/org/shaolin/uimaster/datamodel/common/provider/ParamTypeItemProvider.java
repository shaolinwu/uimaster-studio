...
/**
 * This is the item provider adapter for a {@link org.shaolin.uimaster.datamodel.common.ParamType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParamTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParamType_mandatory_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParamType_mandatory_feature", "_UI_ParamType_type"),
				 CommonPackage.Literals.PARAM_TYPE__MANDATORY,
				 true,
				 false,
				 false,
	...
	protected void addScopePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParamType_scope_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParamType_scope_feature", "_UI_ParamType_type"),
				 CommonPackage.Literals.PARAM_TYPE__SCOPE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ParamType.class)) {
			case CommonPackage.PARAM_TYPE__MANDATORY:
			case CommonPackage.PARAM_TYPE__SCOPE:
