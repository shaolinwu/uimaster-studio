...
/**
 * This is the item provider adapter for a {@link org.shaolin.uimaster.datamodel.common.ExpressionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExpressionTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExpressionType_expressionString_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExpressionType_expressionString_feature", "_UI_ExpressionType_type"),
				 CommonPackage.Literals.EXPRESSION_TYPE__EXPRESSION_STRING,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ExpressionType)object).getItemkey();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ExpressionType.class)) {
			case CommonPackage.EXPRESSION_TYPE__EXPRESSION_STRING:
